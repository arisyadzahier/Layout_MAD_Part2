...
class GridRoom extends StatefulWidget {
  const GridRoom({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _GridRoomState createState() => _GridRoomState();
}
...
class _GridRoomState extends State<GridRoom> {
  void iconPressed1() {
    setState(() {
      Grid1 = !Grid1;
    });
